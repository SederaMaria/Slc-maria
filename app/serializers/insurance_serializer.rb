...
class InsuranceSerializer < ApplicationSerializer
  attributes :company_name, :property_damage, :bodily_injury_per_person, :bodily_injury_per_occurrence, 
             :comprehensive, :collision, :effective_date, :expiration_date, :policy_number, :loss_payee, :additional_insured
end
